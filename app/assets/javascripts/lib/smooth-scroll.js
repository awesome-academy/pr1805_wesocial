    ...
    var t, n, o, r, a, c, l, i = {},
        ...
        m = function(e) {
            ...
            for (var t, n = String(e), o = n.length, r = -1, a = "", c = n.charCodeAt(0); ++r < o;) {
                ...
                t >= 1 && t <= 31 || 127 == t || 0 === r && t >= 48 && t <= 57 || 1 === r && t >= 48 && t <= 57 && 45 === c ? a += "\\" + t.toString(16) + " " : a += t >= 128 || 45 === t || 95 === t || t >= 48 && t <= 57 || t >= 65 && t <= 90 || t >= 97 && t <= 122 ? n.charAt(r) : "\\" + n.charAt(r)
            }
            return "#" + a
        },
        p = function(e, t) {
    ...
    i.animateScroll = function(n, o, c) {
        ...
        if (d || h) {
            ...
            var b, E, I = d ? n : g(h, a, parseInt("function" == typeof u.offset ? u.offset() : u.offset, 10)),
                ...
                M = function() {
                    b = (j += 16) / parseInt(u.speed, 10), b = b > 1 ? 1 : b, E = m + H * p(u.easing, b), e.scrollTo(0, Math.floor(E)), C(E, I, l)
                };
            0 === e.pageYOffset && e.scrollTo(0, 0), clearInterval(l), l = setInterval(M, 16)
        }
    };
    var E = function(t) {
            try {
        ...
        I = function(r) {
            if (0 === r.button && !r.metaKey && !r.ctrlKey && (o = h(r.target, t.selector)) && "a" === o.tagName.toLowerCase() && o.hostname === e.location.hostname && o.pathname === e.location.pathname && /#/.test(o.href)) {
                ...
                if ("#" === a) {
                    r.preventDefault();
                    var c = (n = document.body).id ? n.id : "smooth-scroll-top";
                    return n.setAttribute("data-scroll-id", c), n.id = "", void(e.location.hash.substring(1) === c ? E() : e.location.hash = c)
                }(n = document.querySelector(a)) && (n.setAttribute("data-scroll-id", n.id), n.id = "", o.hash === e.location.hash && (r.preventDefault(), E()))
            }
        },
        H = function(e) {
