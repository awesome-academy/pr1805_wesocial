! function(t) {
    ...
    var h = 0,
        r = function() {
            var i, s = o.userAgent,
                e = /msie\s\d+/i;
            return s.search(e) > 0 && (i = e.exec(s).toString(), (i = i.split(" ")[1]) < 9) && (t("html").addClass("lt-ie9"), !0)
        }();
    ...
    n.prototype = {
            ...
            pointerFocus: function(t) {
                if (!this.target) {
                    var i, s;
                    i = (s = "single" === this.options.type ? this.$cache.single : this.$cache.from).offset().left, i += s.width() / 2 - 1, this.pointerClick("single", {
            ...
            convertToPercent: function(t, i) {
                var s, o, e = this.options.max - this.options.min,
                    h = e / 100;
