                ...
                t.defaults.line = {
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        if (s.dataset._model.spanGaps && (u = u.filter(function(t) {
                            ...
                            for (e = 0, i = u.length; e < i; ++e) n = u[e]._model, o = a.splineCurve(a.previousItem(u, e)._model, n, a.nextItem(u, e)._model, s.dataset._model.tension), n.controlPointPreviousX = o.previous.x, n.controlPointPreviousY = o.previous.y, n.controlPointNextX = o.next.x, n.controlPointNextY = o.next.y;
                        if (r.chart.options.elements.line.capBezierPoints)
                            for (e = 0, i = u.length; e < i; ++e)(n = u[e]._model).controlPointPreviousX = t(n.controlPointPreviousX, l.left, l.right), n.controlPointPreviousY = t(n.controlPointPreviousY, l.top, l.bottom), n.controlPointNextX = t(n.controlPointNextX, l.left, l.right), n.controlPointNextY = t(n.controlPointNextY, l.top, l.bottom)
                    },
                    draw: function(a) {
                        var i, n, o = this,
                            r = o.getMeta(),
                            ...
                            if (i.each(n.ticks, function(t, a) {
                                    if (void 0 !== t && null !== t) {
                                        ...
                                        if ((!(r > 1 && a % r > 0 || a % r == 0 && a + r >= n.ticks.length) || s) && void 0 !== t && null !== t) {
                                            ...
                                            var h, g, m, v, k, S, w, C, _, F, V = "middle",
                                                R = "middle";
                                            if (p) {
