! function(e, t) {
    ...
    function m(e, n) {
        var o = te(),
            ...
            d = +l.borderLeftWidth.split("px")[0],
            m = c({
                top: f.top - s.top - u,
                left: f.left - s.left - d,
                width: f.width,
                height: f.height
            });
    ...
    function B(e, t, n, o) {
        ...
        f.addEventListener(t, n, {
            passive: !0
        }), i || B(r(f.parentNode), t, n, o), o.push(f)
    }
    ...
    for (var z = Math.min, G = Math.floor, V = Math.max, _ = ["native code", "[object MutationObserverConstructor]"], X = "undefined" != typeof window, J = ["Edge", "Trident", "Firefox"], Q = 0, Z = 0; Z < J.length; Z += 1)
        if (X && 0 <= navigator.userAgent.indexOf(J[Z])) {
            Q = 1;
            break
        }
    var $, ee = X && function(e) {
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, p = void 0 === f ? t.gpuAcceleration : f,
                        ...
                        g = W("transform");
                    if (a = "bottom" == c ? -l.height + d.bottom : d.top, s = "right" == m ? -l.width + d.right : d.left, p && g) u[g] = "translate3d(" + s + "px, " + a + "px, 0)", u[c] = 0, u[m] = 0, u.willChange = "transform";
                    else {
                        var v = "bottom" == c ? -1 : 1,
                            b = "right" == m ? -1 : 1;
