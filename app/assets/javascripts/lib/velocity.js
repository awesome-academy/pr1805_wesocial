! function(e) {
    ...
    if (!e.jQuery) {
        ...
        r.isWindow = function(e) {
            ...
            if (a) {
                if (n)
                    for (; i > o && !1 !== r.apply(e[o], a); o++);
                else
                    for (o in e)
                        if (!1 === r.apply(e[o], a)) break
            } else if (n)
                for (; i > o && !1 !== r.call(e[o], o, e[o]); o++);
            else
                for (o in e)
                    if (!1 === r.call(e[o], o, e[o])) break; return e
        }, r.data = function(e, t, o) {
            if (void 0 === o) {
                var i = (n = e[r.expando]) && a[n];
                if (void 0 === t) return i;
                if (i && t in i) return i[t]
            } else if (void 0 !== t) {
                var n = e[r.expando] || (e[r.expando] = ++r.uuid);
                return a[n] = a[n] || {}, a[n][t] = o, o
            }
            ...
            if (e) {
                a = (a || "fx") + "queue";
                var i = r.data(e, a);
                return o ? (!i || r.isArray(o) ? i = r.data(e, a, function(e, r) {
                    var a = r || [];
    ...
    return function(e, t, r, a) {
        ...
        function l(e, r, a, o) {
            ...
            function f(t, r, o) {
                var i, n, s = 0;
                do {
                    n = r + (o - r) / 2, (i = l(n, e, a) - t) > 0 ? o = n : r = n
            ...
            function d(t) {
                ...
                var n = r + (t - w[--o]) / (w[o + 1] - w[o]) * x,
                    s = u(n, e, a);
                return s >= m ? c(t, n) : 0 == s ? n : f(t, r, r + x)
            }
        ...
        function u(e, t) {
            var r = e;
            return y.isString(e) ? b.Easings[e] || (r = !1) : r = y.isArray(e) && 1 === e.length ? s.apply(null, e) : y.isArray(e) && 2 === e.length ? x.apply(null, e.concat([t])) : !(!y.isArray(e) || 4 !== e.length) && l.apply(null, e), !1 === r && (r = b.Easings[b.defaults.easing] ? b.defaults.easing : v), r
        }
        ...
        function p(e, t) {
            ...
            for (var r = b.State.calls[e][0], o = b.State.calls[e][1], i = b.State.calls[e][2], s = b.State.calls[e][4], l = !1, u = 0, c = r.length; c > u; u++) {
                var p = r[u].element;
                if (t || i.loop || ("none" === i.display && S.setPropertyValue(p, "display", i.display), "hidden" === i.visibility && S.setPropertyValue(p, "visibility", i.visibility)), !0 !== i.loop && (f.queue(p)[1] === a || !/\.velocityQueueEntryFlag/i.test(f.queue(p)[1])) && n(p)) {
                ...
                s && !0 !== i.loop && s(o), n(p) && !0 === i.loop && !t && (f.each(n(p).tweensContainer, function(e, t) {
                    /^rotate/.test(e) && 360 === parseFloat(t.endValue) && (t.endValue = 0, t.startValue = 360), /^backgroundPosition/.test(e) && 100 === parseFloat(t.endValue) && "%" === t.unitType && (t.endValue = 0, t.startValue = 100)
                }), b(p, "reverse", {
                    loop: !0,
                    delay: i.delay
                })), !1 !== i.queue && f.dequeue(p, i.queue)
            }
            b.State.calls[e] = !1;
            for (var g = 0, y = b.State.calls.length; y > g; g++)
                if (!1 !== b.State.calls[g]) {
                    l = !0;
                    break
            ...
            if (!(7 >= d)) {
                ...
                var x = function() {
                    ...
                    return function e(t, a, o) {
                        var i, n, s, l = {
                            ...
                            u = [0],
                            c = 0;
                        for (t = parseFloat(t) || 500, a = parseFloat(a) || 20, o = o || null, l.tension = t, l.friction = a, (i = null !== o) ? (c = e(t, a), n = c / o * .016) : n = .016; s = r(s || l, n), u.push(1 + s.x), c += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;);
                        return i ? function(e) {
                ...
                var S = b.CSS = {
                    ...
                    Hooks: {
                        ...
                        registered: {},
                        register: function() {
                            for (i = 0; i < S.Lists.colors.length; i++) {
                                var e = "color" === S.Lists.colors[i] ? "0 0 0 1" : "255 255 255 1";
                                S.Hooks.templates[S.Lists.colors[i]] = ["Red Green Blue Alpha", e]
                            }
                            var t, r, a;
                            if (d)
                                for (t in S.Hooks.templates) {
                                    a = (r = S.Hooks.templates[t])[0].split(" ");
                                    var o = r[1].match(S.RegEx.valueSplit);
                                    "Color" === a[0] && (a.push(a.shift()), o.push(o.shift()), S.Hooks.templates[t] = [a.join(" "), o.join(" ")])
                                }
                            for (t in S.Hooks.templates) {
                                a = (r = S.Hooks.templates[t])[0].split(" ");
                                for (var i in a) {
                        ...
                        extractValue: function(e, t) {
                            ...
                            if (r) {
                                var a = r[0],
                                    o = r[1];
                                return (t = S.Hooks.cleanRootPropertyValue(a, t)).toString().match(S.RegEx.valueSplit)[o]
                            }
                            return t
                        },
                        injectValue: function(e, t, r) {
                            ...
                            if (a) {
                                var o, i = a[0],
                                    n = a[1];
                                return r = S.Hooks.cleanRootPropertyValue(i, r), o = r.toString().match(S.RegEx.valueSplit), o[n] = t, o.join(" ")
                            }
                            return r
                        }
                    },
                    Normalizations: {
                        ...
                        register: function() {
                            ...
                            for (e = 0; e < S.Lists.transformsBase.length; e++) ! function() {
                    ...
                    Values: {
                        hexToRgb: function(e) {
                            ...
                            return e = e.replace(r, function(e, t, r, a) {
                                return t + t + r + r + a + a
                            }), (t = a.exec(e)) ? [parseInt(t[1], 16), parseInt(t[2], 16), parseInt(t[3], 16)] : [0, 0, 0]
                        },
                    ...
                    getPropertyValue: function(e, r, o, i) {
                        function s(e, r) {
                            ...
                            if (8 >= d) l = f.css(e, r);
                                ...
                                var g;
                                g = n(e) === a ? t.getComputedStyle(e, null) : n(e).computedStyle ? n(e).computedStyle : n(e).computedStyle = t.getComputedStyle(e, null), "borderColor" === r && (r = "borderTopColor"), ("" === (l = 9 === d && "filter" === r ? g.getPropertyValue(r) : g[r]) || null === l) && (l = e.style[r]), o()
                            }
                        ...
                        if (S.Hooks.registered[r]) {
                            ...
                            var p, g;
                            "transform" !== (p = S.Normalizations.registered[r]("name", e)) && (g = s(e, S.Names.prefixCheck(p)[0]), S.Values.isCSSNullValue(g) && S.Hooks.templates[r] && (g = S.Hooks.templates[r][1])), l = S.Normalizations.registered[r]("extract", e, g)
                        }
                        if (!/^[\d-]/.test(l))
                ...
                var P = function() {
                    ...
                    function o() {
                        function e() {
                            ...
                            if ("scroll" === k) {
                                var d, h, x, P = /^x$/i.test(s.axis) ? "Left" : "Top",
                                    C = parseFloat(s.offset) || 0;
                                s.container ? y.isWrapped(s.container) || y.isNode(s.container) ? (s.container = s.container[0] || s.container, d = s.container["scroll" + P], x = d + f(i).position()[P.toLowerCase()] + C) : s.container = null : (d = b.State.scrollAnchor[b.State["scrollProperty" + P]], h = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === P ? "Top" : "Left")]], x = f(i).offset()[P.toLowerCase()] + C), l = {
                                    scroll: {
                                        rootPropertyValue: !1,
                                        startValue: d,
                                        currentValue: d,
                                ...
                                E = f.extend(!0, {}, n(i).tweensContainer);
                                for (var A in E)
                                    if ("element" !== A) {
                                        var F = E[A].startValue;
                                        E[A].startValue = E[A].currentValue = E[A].endValue, E[A].endValue = F, y.isEmptyObject(v) || (E[A].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + A + "): " + JSON.stringify(E[A]), i)
                                    }
                                l = E
                            } else if ("start" === k) {
                                var E;
                                n(i).tweensContainer && !0 === n(i).isAnimating && (E = n(i).tweensContainer), f.each(m, function(t, r) {
                                ...
                                for (var j in m) {
                                    ...
                                    var q = S.Hooks.getRoot(j),
                                        $ = !1;
                                    if (n(i).isSVG || "tween" === q || !1 !== S.Names.prefixCheck(q)[1] || S.Normalizations.registered[q] !== a) {
                                        (s.display !== a && null !== s.display && "none" !== s.display || s.visibility !== a && "hidden" !== s.visibility) && /opacity|filter/.test(j) && !z && 0 !== R && (z = 0), s._cacheValues && E && E[j] ? (z === a && (z = E[j].endValue + E[j].unitType), $ = n(i).rootPropertyValueCache[q]) : S.Hooks.registered[j] ? z === a ? ($ = S.getPropertyValue(i, q), z = S.getPropertyValue(i, j, $)) : $ = S.Hooks.templates[q][1] : z === a && (z = S.getPropertyValue(i, j));
                                        var M, I, B, W = !1;
                                        if (M = p(j, z), z = M[0], B = M[1], M = p(j, R), R = M[0].replace(/^([+-\/*])=/, function(e, t) {
                                                return W = t, ""
                                            ...
                                            if (0 === R) I = B;
                                                ...
                                                o = o || function() {
                                                    var e = {
                                                        ...
                                                        o = e.fontSize === H.lastFontSize;
                                                    H.lastParent = e.myParent, H.lastPosition = e.position, H.lastFontSize = e.fontSize;
                                                    var s = 100,
                                                        l = {};
                                                    if (o && a) l.emToPx = H.lastEmToPx, l.percentToPxWidth = H.lastPercentToPxWidth, l.percentToPxHeight = H.lastPercentToPxHeight;
                                                    else {
                                                        ...
                                                        }), b.CSS.setPropertyValue(u, "paddingLeft", s + "em"), l.percentToPxWidth = H.lastPercentToPxWidth = (parseFloat(S.getPropertyValue(u, "width", null, !0)) || 1) / s, l.percentToPxHeight = H.lastPercentToPxHeight = (parseFloat(S.getPropertyValue(u, "height", null, !0)) || 1) / s, l.emToPx = H.lastEmToPx = (parseFloat(S.getPropertyValue(u, "paddingLeft")) || 1) / s, e.myParent.removeChild(u)
                                                    }
                                                    return null === H.remToPx && (H.remToPx = parseFloat(S.getPropertyValue(r.body, "fontSize")) || 16), null === H.vwToPx && (H.vwToPx = parseFloat(t.innerWidth) / 100, H.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = H.remToPx, l.vwToPx = H.vwToPx, l.vhToPx = H.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), i), l
                                                }();
                                                var G = /margin|padding|left|right|width|text|word|letter/i.test(j) || /X$/.test(j) || "x" === j ? "x" : "y";
                                                switch (B) {
                                                    case "%":
                                                        z *= "x" === G ? o.percentToPxWidth : o.percentToPxHeight;
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                                ...
                                                switch (I) {
                                                    case "%":
                                                        z *= 1 / ("x" === G ? o.percentToPxWidth : o.percentToPxHeight);
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                        ...
                                        l[j] = {
                                            ...
                                            unitType: I,
                                            easing: O
                                        }, b.debug && console.log("tweensContainer (" + j + "): " + JSON.stringify(l[j]), i)
                                    } else b.debug && console.log("Skipping [" + q + "] due to a lack of browser support.")
                                }
                                l.element = i
                            }
                            l.element && (S.Values.addClass(i, "velocity-animating"), N.push(l), "" === s.queue && (n(i).tweensContainer = l, n(i).opts = s), n(i).isAnimating = !0, V === w - 1 ? (b.State.calls.push([N, g, s, null, T.resolver]), !1 === b.State.isTicking && (b.State.isTicking = !0, c())) : V++)
                        }
                        var o, i = this,
                            s = f.extend({}, b.defaults, v),
                            l = {};
                        switch (n(i) === a && b.init(i), parseFloat(s.delay) && !1 !== s.queue && f.queue(i, s.queue, function(e) {
                        ...
                        }!1 !== b.mock && (!0 === b.mock ? s.duration = s.delay = 1 : (s.duration *= parseFloat(b.mock) || 1, s.delay *= parseFloat(b.mock) || 1)), s.easing = u(s.easing, s.duration), s.begin && !y.isFunction(s.begin) && (s.begin = null), s.progress && !y.isFunction(s.progress) && (s.progress = null), s.complete && !y.isFunction(s.complete) && (s.complete = null), s.display !== a && null !== s.display && (s.display = s.display.toString().toLowerCase(), "auto" === s.display && (s.display = b.CSS.Values.getDisplayType(i))), s.visibility !== a && null !== s.visibility && (s.visibility = s.visibility.toString().toLowerCase()), s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread, !1 === s.queue ? s.delay ? setTimeout(e, s.delay) : e() : f.queue(i, s.queue, function(t, r) {
                            return !0 === r ? (T.promise && T.resolver(g), !0) : (b.velocityQueueEntryFlag = !0, void e())
                    ...
                    if (y.isWrapped(this) ? (s = !1, d = 0, g = this, l = this) : (s = !0, d = 1, g = x ? arguments[0].elements || arguments[0].e : arguments[0]), g = i(g)) {
                        ...
                        if (!/^(stop|finish|finishAll)$/i.test(m) && !f.isPlainObject(v)) {
                            v = {};
                            for (var C = d + 1; C < arguments.length; C++) y.isArray(arguments[C]) || !/^(fast|normal|slow)$/i.test(arguments[C]) && !/^\d/.test(arguments[C]) ? y.isString(arguments[C]) || y.isArray(arguments[C]) ? v.easing = arguments[C] : y.isFunction(arguments[C]) && (v.complete = arguments[C]) : v.duration = arguments[C]
                        }
                        var T = {
                            promise: null,
                            resolver: null,
                        ...
                        switch (m) {
                            ...
                            case "stop":
                                f.each(g, function(e, t) {
                                    n(t) && n(t).delayTimer && (clearTimeout(n(t).delayTimer.setTimeout), n(t).delayTimer.next && n(t).delayTimer.next(), delete n(t).delayTimer), "finishAll" !== m || !0 !== v && !y.isString(v) || (f.each(f.queue(t, y.isString(v) ? v : ""), function(e, t) {
                                        y.isFunction(t) && t()
                                ...
                                return f.each(b.State.calls, function(e, t) {
                                    t && f.each(t[1], function(r, o) {
                                        var i = v === a ? "" : v;
                                        return !0 !== i && t[2].queue !== i && (v !== a || !1 !== t[2].queue) || void f.each(g, function(r, a) {
                                            a === o && ((!0 === v || y.isString(v)) && (f.each(f.queue(a, y.isString(v) ? v : ""), function(e, t) {
                                                y.isFunction(t) && t(null, !0)
                                            }), f.queue(a, y.isString(v) ? v : "", [])), "stop" === m ? (n(a) && n(a).tweensContainer && !1 !== i && f.each(n(a).tweensContainer, function(e, t) {
                                                t.endValue = t.currentValue
                                            }), A.push(e)) : ("finish" === m || "finishAll" === m) && (t[2].duration = 1))
                                        })
                                    })
                                }), "stop" === m && (f.each(A, function(e, t) {
                                    p(t, !0)
                                }), T.promise && T.resolver(g)), e();
                            default:
                                if (!f.isPlainObject(m) || y.isEmptyObject(m)) {
                                    if (y.isString(m) && b.Redirects[m]) {
                                        var F = (R = f.extend({}, v)).duration,
                                            E = R.delay || 0;
                                        return !0 === R.backwards && (g = f.extend(!0, [], g).reverse()), f.each(g, function(e, t) {
                                            parseFloat(R.stagger) ? R.delay = E + parseFloat(R.stagger) * e : y.isFunction(R.stagger) && (R.delay = E + R.stagger.call(t, e, w)), R.drag && (R.duration = parseFloat(F) || (/^(callout|transition)/.test(m) ? 1e3 : h), R.duration = Math.max(R.duration * (R.backwards ? 1 - e / w : (e + 1) / w), .75 * R.duration, 200)), b.Redirects[m].call(t, t, R || {}, e, w, g, T.promise ? T : a)
                                        }), e()
                                    }
                        ...
                        if (R.loop = parseInt(R.loop), L = 2 * R.loop - 1, R.loop)
                            for (var O = 0; L > O; O++) {
                                ...
                                O === L - 1 && (z.display = R.display, z.visibility = R.visibility, z.complete = R.complete), P(g, "reverse", z)
                            }
                        return e()
                    }
                };
